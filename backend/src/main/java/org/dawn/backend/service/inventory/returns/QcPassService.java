...
public class QcPassService {
    ...
    public void confirm(List<Long> unitIds) {
    ...
    public List<QcUnitResponse> listQcUnits(List<ProductUnitStatus> statuses) {
        ...
        var unitToItem = exportReceiptItemUnitRepository.findByProductUnitIdIn(unitIds).stream()
                .collect(Collectors.toMap(ExportReceiptItemUnit::getProductUnitId, ExportReceiptItemUnit::getExportReceiptItemId, (a, b) -> b));
        ...
        var responses = units.stream().map(u -> new QcUnitResponse(
                u.getId(),
                u.getSerialNumber(),
                u.getProductId(),
                ...
                evidence.get(u.getId()) != null ? evidence.get(u.getId()).getDescription() : null,
                evidence.get(u.getId()) != null ? evidence.get(u.getId()).getEvidenceImage() : null,
                lastLog.get(u.getId()) != null ? lastLog.get(u.getId()).getCreatedAt() : null,
                lastLog.get(u.getId()) != null && lastLog.get(u.getId()).getChangedBy() != null
                        ? userNames.get(lastLog.get(u.getId()).getChangedBy())
                        : null,
